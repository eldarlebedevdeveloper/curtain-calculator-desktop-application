  ...
  function addProduct() {
    ...
    if (whyPlus) {
      if (!addColor.value) {
        ...
        product.append(
          createProduct('product_color', 'Изменить цвет', addColor.value)
        )
        product.append(
          createProduct('product_type', '', addType.value, [
            'Compact и фалш шторы',
            'MINI',
            'STANDART',
            'MAXIMUS',
            'UNI Плоскю Направл',
        ...
        product.append(
          createProduct('product_price', 'Изменить цену', addPrice.value)
        )
        if (whyPlus) {
          product.append(
            createProduct('product_plus', 'Изменить доб', addPlus.value)
          )
        }
